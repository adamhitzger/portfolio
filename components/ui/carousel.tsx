...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  const lang = useSearchParams().get("lang") || "cs"
  const xRef = useRef(0);
  const yRef = useRef(0);
      ...
      >
        ...
        >
          <h2 className="text-lg md:text-2xl lg:text-4xl font-semibold  relative">
            {lang === "en" ? slide.title_en :slide.title_cz}
          </h2>
...
const CarouselControl = ({
  ...
  return (
    <button
      className={`w-10 h-10 flex items-center mx-2 justify-center bg-black hover:-translate-y-0.5 rounded-full active:translate-y-0.5 transition duration-200 ${
